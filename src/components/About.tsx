    ...
    <section id="about" className="py-20 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-2xl font-bold text-white mb-6">Technical Philosophy</h3>
            ...
            <div className="flex flex-wrap gap-3">
              <span className="bg-blue-900 text-blue-200 px-3 py-1 rounded-full text-sm font-medium">Python</span>
              <span className="bg-blue-900 text-blue-200 px-3 py-1 rounded-full text-sm font-medium">Flask</span>
              <span className="bg-blue-900 text-blue-200 px-3 py-1 rounded-full text-sm font-medium">PyQt</span>
              <span className="bg-blue-900 text-blue-200 px-3 py-1 rounded-full text-sm font-medium">PHP</span>
              <span className="bg-blue-900 text-blue-200 px-3 py-1 rounded-full text-sm font-medium">Linux</span>
              <span className="bg-blue-900 text-blue-200 px-3 py-1 rounded-full text-sm font-medium">Docker</span>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-lg font-semibold text-white">Infrastructure Management</h4>
              </div>
            ...
            <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-lg font-semibold text-white">Application Development</h4>
              </div>
              <p className="text-gray-300">
            ...
            <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-lg font-semibold text-white">Decentralized Ecosystem</h4>
              </div>
              <p className="text-gray-300">
